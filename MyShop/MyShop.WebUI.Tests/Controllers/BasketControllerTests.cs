...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "arie.groenendijk@xxx.com", ZipCode = "3645" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("arie.groenendijk@xxxx.com", "Forms"),null);
